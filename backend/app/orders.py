...
def export_csv(order, version):
    ...
    writer.writerow(["supplier_id", "sku_1c", "supplier_article", "name", "order_unit", "quantity", "stock_unit", "stock_equivalent", "warehouse_id", "reason", "risk", "as_of", "version", "editor_role", "editor_id"])
